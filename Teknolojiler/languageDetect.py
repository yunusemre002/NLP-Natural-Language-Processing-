...
reviews_df = pd.read_csv("C:/Users/Demir/Desktop/Final_Project/DataSets/London_new1.csv", encoding = "ISO-8859-1")   # read data   !!!!!
...
print("toplam: {},  English: {}, Others: {}".format(len(reviews_df_com), j, len(reviews_df_com)-j))
